...
const account1 = {
  ...
  movementsDates: [
    ...
    "2022-12-31T17:01:17.194Z",
    "2023-01-04T23:36:17.929Z",
...
const startLogOutTimer = function () {
  ...
  function tick() {
    ...
    if (time === 0) {
      ...
      labelWelcome.textContent = "Login Timeout";
    }

    time--;
  }
  tick(); //Avoid one second delay start
...
btnLogin.addEventListener("click", function (e) {
  ...
  if (currentAccount?.pin === +inputLoginPin.value) {
    ...
    // Start Timer and clear if timer exists
...
// const diameter = 28_746_502_100_000;
...
// console.log(new Date(1673072201730));
